...
| **[DeepSeek](DeepSeek/)** | DeepSeek AI | [★☆☆☆☆☆☆☆☆☆] 1/10 (jb) / [★★★★★★★★★☆] 9/10 (raw) | 8/10 | 1M (V4) | Free / pennies | MIT | 8 |
...
| **[GLM by Z.ai](GLM/)** | Zhipu AI | [★★★★☆☆☆☆☆☆] 4/10 | 9/10 | 1M (5.2/5.3) | Free / $0.80/1M in | MIT (5.2) / Custom (5.3) | 7 |
...
- **Mistral** — Magistral Small 24B runs on single RTX 4090 or Mac 32GB RAM; Ministral 3 (3B/8B/14B)
...
- **DeepSeek** — $0.14/1M input, $0.28/1M output (V4-Flash); free via chat and some OpenRouter routes
